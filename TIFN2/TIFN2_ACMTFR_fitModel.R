...
# Fit model
model = acmtfr_opt(Z, Ynorm, numComponents=numComponents, method="L-BFGS", pi=piValue, nstart=100, numCores=parallel::detectCores())
saveRDS(model, paste0("./TIFN2_ACMTFR_model_", piValue, ".RDS"))
