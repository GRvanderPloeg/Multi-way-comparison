...
CV_ACMTFR = ACMTFR_modelSelection(datasets, modes, Ynorm, maxNumComponents=5, method="L-BFGS", pi=piValue, nstart=10, cvFolds=10, numCores=parallel::detectCores())
saveRDS(CV_ACMTFR, paste0("./TIFN2_CV_ACMTF_", piValue, ".RDS"))
