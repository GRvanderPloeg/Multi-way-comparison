...
saveRDS(result, "./GOHTRANS_ACMTFR_model_1_deltaT.RDS")

result = acmtfr_opt(Z, Ynorm, 2, pi=0.90, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
saveRDS(result, "./GOHTRANS_ACMTFR_model_90_deltaT.RDS")

result = acmtfr_opt(Z, Ynorm, 2, pi=0.80, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
saveRDS(result, "./GOHTRANS_ACMTFR_model_80_deltaT.RDS")

result = acmtfr_opt(Z, Ynorm, 2, pi=0.70, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
saveRDS(result, "./GOHTRANS_ACMTFR_model_70_deltaT.RDS")

result = acmtfr_opt(Z, Ynorm, 2, pi=0.60, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
saveRDS(result, "./GOHTRANS_ACMTFR_model_60_deltaT.RDS")

result = acmtfr_opt(Z, Ynorm, 2, pi=0.50, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
saveRDS(result, "./GOHTRANS_ACMTFR_model_50_deltaT.RDS")
