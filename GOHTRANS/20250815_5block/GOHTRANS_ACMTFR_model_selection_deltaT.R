...
homogenizedSamples5 = intersect(NPLStoolbox::Cornejo2025$Circulatory_hormones$mode1$subject, outcome$subject)

homogenizedSamples = intersect(intersect(intersect(homogenizedSamples1, homogenizedSamples2), intersect(homogenizedSamples3,homogenizedSamples4)), homogenizedSamples3)
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_50_deltaT_5block.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_60_deltaT_5block.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_70_deltaT_5block.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_80_deltaT_5block.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_90_deltaT_5block.RDS")
