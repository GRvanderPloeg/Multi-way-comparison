...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_50_deltaT.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_60_deltaT.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_70_deltaT.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_80_deltaT.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_90_deltaT.RDS")
