...
# result = acmtfr_opt(Z, Ynorm, 2, pi=1, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
# saveRDS(result, "./GOHTRANS_ACMTFR_model_1.RDS")

# result = acmtfr_opt(Z, Ynorm, 1, pi=0.95, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
# saveRDS(result, "./GOHTRANS_ACMTFR_model_95.RDS")
#
# result = acmtfr_opt(Z, Ynorm, 1, pi=0.90, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
# saveRDS(result, "./GOHTRANS_ACMTFR_model_90.RDS")
#
# result = acmtfr_opt(Z, Ynorm, 1, pi=0.85, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
# saveRDS(result, "./GOHTRANS_ACMTFR_model_85.RDS")
#
# result = acmtfr_opt(Z, Ynorm, 1, pi=0.80, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
# saveRDS(result, "./GOHTRANS_ACMTFR_model_80.RDS")
#
# result = acmtfr_opt(Z, Ynorm, 1, pi=0.75, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
# saveRDS(result, "./GOHTRANS_ACMTFR_model_75.RDS")

result = acmtfr_opt(Z, Ynorm, 1, pi=0.70, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
saveRDS(result, "./GOHTRANS_ACMTFR_model_70.RDS")

result = acmtfr_opt(Z, Ynorm, 1, pi=0.65, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
saveRDS(result, "./GOHTRANS_ACMTFR_model_65.RDS")

result = acmtfr_opt(Z, Ynorm, 1, pi=0.60, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
saveRDS(result, "./GOHTRANS_ACMTFR_model_60.RDS")

result = acmtfr_opt(Z, Ynorm, 1, pi=0.55, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
saveRDS(result, "./GOHTRANS_ACMTFR_model_55.RDS")

# result = acmtfr_opt(Z, Ynorm, 1, pi=0.50, method="L-BFGS", nstart=100, numCores=parallel::detectCores())
# saveRDS(result, "./GOHTRANS_ACMTFR_model_50.RDS")
