...
# saveRDS(result, "./GOHTRANS_CV_ACMTFR_50.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_60.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_70.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_80.RDS")
...
saveRDS(result, "./GOHTRANS_CV_ACMTFR_90.RDS")
