...
result = NPLStoolbox::ncrossreg(Cornejo2025$Saliva$data, Ycnt)
saliva_NPLS = NPLStoolbox::triPLS1(Cornejo2025$Saliva$data, Ycnt, 1)
...
result = NPLStoolbox::ncrossreg(Cornejo2025$Cytokines$data, Ycnt)
cytokine_NPLS = NPLStoolbox::triPLS1(Cornejo2025$Cytokines$data, Ycnt, 1)
...
cytokine_NPLS$varExpX
cytokine_NPLS$varExpY
```
