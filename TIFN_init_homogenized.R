...
# Remove subject 26QQr0 to homogenize the datasets
mask = metadata$subject != "26QQrO"
counts = counts[mask,]
metadata = metadata[mask,]
...
# Save
saveRDS(processedTongue, "./Data/TIFN/tongue_homogenized.RDS")
saveRDS(processedLowling, "./Data/TIFN/lowling_homogenized.RDS")
saveRDS(processedLowinter, "./Data/TIFN/lowinter_homogenized.RDS")
saveRDS(processedUpling, "./Data/TIFN/upling_homogenized.RDS")
saveRDS(processedUpinter, "./Data/TIFN/upinter_homogenized.RDS")
saveRDS(processedSaliva, "./Data/TIFN/saliva_homogenized.RDS")
...
saveRDS(metabolomics, "./Data/TIFN/metabolomics_homogenized.RDS")
